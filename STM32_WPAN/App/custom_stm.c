...
/* Private typedef -----------------------------------------------------------*/
typedef struct{
  uint16_t  CustomP2P_ServerHdle;                    /**< P2P_Server handle */
...
/*
 ...
 generator:
 227e665b-af27-449f-aa2b-6b9da2806026: Service 128bits UUID
 227e665c-af27-449f-aa2b-6b9da2806026: Characteristic_1 128bits UUID


 */
#define COPY_P2P_SERVER_UUID(uuid_struct)          COPY_UUID_128(uuid_struct,0x22,0x7e,0x66,0x5b,0xaf,0x27,0x44,0x9f,0xaa,0x2b,0x6b,0x9d,0xa2,0x80,0x60,0x26)
#define COPY_MY_LED_CHAR_UUID(uuid_struct)    COPY_UUID_128(uuid_struct,0x22,0x7e,0x66,0x5c,0xaf,0x27,0x44,0x9f,0xaa,0x2b,0x6b,0x9d,0xa2,0x80,0x60,0x26)
...
tBleStatus Custom_STM_App_Update_Char(Custom_STM_Char_Opcode_t CharOpcode, uint8_t *pPayload)
{
  ...
  switch (CharOpcode)
  {
    ...
    case CUSTOM_STM_LED_C:
      ret = aci_gatt_update_char_value(CustomContext.CustomP2P_ServerHdle,
                                       CustomContext.CustomLed_CHdle,
                                       0, /* charValOffset */
